...
import com.pet.bean.EmpBean;
import com.pet.dao.EmpDAO;
import com.pet.dao.ScheduleQueryDAO;
...
public class GetScheduleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			request.getRequestDispatcher("/views/petAdmin/admin/appointment/selectempschedule.jsp").forward(request, response);
