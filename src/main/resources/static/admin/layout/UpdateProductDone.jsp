												...
												<div class="col-sm-10">
													<div class="input-group date" id="reservationdate"
														...
														<input type="text"
															...
															value="<%=product.getExpireDate()%>" readonly disabled />
													</div>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<select class="form-control select2" style="width: 100%;"
														...
														<option><%=product.getIsActive() ? "是" : "否"%>
														</option>
													</select>
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-2 col-form-label">更新時間:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="inputPassword3"
														placeholder="" name="update"
														value="<%=product.getUpdatedAt()%>" readonly />
												</div>
											</div>
										</div>
									</form>
