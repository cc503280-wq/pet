							...
							<div class="card">
								<div class="card-header d-flex align-items-center">
									...
									<div class="d-flex align-items-center ml-auto">
										...
										<form
											action="${pageContext.request.contextPath}/CategorySearch"
											method="get"
											...
											<div class="input-group input-group-sm" style="width: 150px;">
												<select name="category_id" class="form-control">
													...
													<option value="<%=category.getCategoryId()%>"
														<%=isSelected ? "selected" : ""%>><%=category.getCategoryName()%></option>
													<%
													}
													%>
												</select>
										...
										<form action="${pageContext.request.contextPath}/FuzzySearch"
											method="get">
											<div class="input-group input-group-sm" style="width: 150px;">
										...
										<tbody>
											...
											<tr>
												...
												<td class="text-center"><a
													...
													href="BeSolded?product_id=<%=product.getProductId()%>"
