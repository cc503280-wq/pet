...
<body class="hold-transition sidebar-mini sidebar-collapse">
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12 box1">
              <h1>會員管理</h1>
              <a href="AdminQueryAll.html" class="btn btn-secondary btn-sm">
                回列表
              </a>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card card-info">
                  ...
                  <form class="form-horizontal" id="updateForm">
                    <div class="card-body">
                      ...
                      <div class="form-group row">
                        <label for="id" class="col-sm-2 col-form-label">姓名:</label>
                        <div class="col-sm-10">
  ...
  <script>
   ...
   // 載入管理員資料
      $.ajax({
          url: '/pet/AdminServlet',
          method: 'GET',
          data: { action: 'queryById', adminId: adminId },
          dataType: 'json',
          ...
          $.ajax({
              ...
              success: function(res) {
                  ...
                  if (res && res.adminId) {
                      ...
                      params.append('id', res.adminId);
                      params.append('name', res.name);
                      params.append('email', res.email);
                      params.append('phone', res.phone);
                      params.append('role', res.role);
                      window.location.href = 'AdminUpdateDone.jsp?' + params.toString();
                  } else {
                      alert('更新失敗，伺服器回傳空值');
                  }
              },
