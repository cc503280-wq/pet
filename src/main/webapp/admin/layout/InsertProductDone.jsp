				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12 box1">
							<h1>商品管理</h1>
							<a href="${pageContext.request.contextPath}/AllProducts" class="btn btn-secondary btn-sm"> 回列表 </a>
						</div>
							...
							<div class="card">
								...
								<div class="card card-info">
									<div class="card-header">
										<h3 class="card-title">新增資料完成</h3>
									</div>
									<div class="alert alert-success mx-4 mt-3 py-2">
										<i class="icon fas fa-check-circle"></i> <strong>新增成功!</strong>
									</div>
									<!-- /.card-header -->
									<!-- form start -->
									<form class="form-horizontal" method="post"
										action="<%=request.getContextPath()%>/InsertProduct">
										<div class="card-body">
											<div class="form-group row">
												<label for="inputEmail3" class="col-sm-2 col-form-label">商敏名稱:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" placeholder="商品名稱"
														name="pname" value="<%=product.getProductName()%>" readonly>
												</div>
											</div>
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-2 col-form-label">商品描述:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="inputPassword3"
														placeholder="商品描述" name="pdes"
											...
											<div class="form-group row">
												<label for="inputPassword3" class="col-sm-2 col-form-label">庫存:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="inputPassword3"
														placeholder="" name="stock"
														value="<%=product.getStock()%>" readonly>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<select class="form-control select2" style="width: 100%;"
														name="category" >
														<option ><%=product.getCategoryName()%></option>														
													</select>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<p class="form-control-static">
														<img src="ImageServlet?file=<%=product.getImageUrl()%>"
															width="200">
													</p>
												</div>
											</div>
											...
											<div class="form-group row">
												<label class="col-sm-2 col-form-label">到期日:</label>
												<div class="col-sm-10">
													<div class="input-group date" id="reservationdate"
														data-target-input="nearest">
														<input type="text"
															class="form-control datetimepicker-input"
															data-target="#reservationdate" name="expiredate" 
															value="<%=product.getExpireDate() %>" readonly />
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<select class="form-control select2" style="width: 100%;"
														name="is_acitve" disabled>
														<option><%=product.getIsActive() ? "是" : "否" %></option>
													</select>
												</div>
											</div>
										</div>
										...
										<div class="card-footer">
											<a href="${pageContext.request.contextPath}/AllProducts" class="btn btn-info float-right">  返回商品管理
											</a>
										</div>
										<!-- /.card-footer -->
									</form>
