<%@page import="com.pet.model.order.orderItemBean"%>
								...
								<div class="card-body">
									<table id="example2" class="table table-bordered table-hover">
										...
										<tbody>
											...
											<%
											List<orderItemBean> list = (List<orderItemBean>) request.getAttribute("orderItemsList");
											if (list != null) {
												for (orderItemBean oi : list) {
											%>
											<tr>
												<td><%=oi.getProductItemId()%></td>
												<td><%=oi.getOrderId()%></td>
												<td><%=oi.getProductId()%></td>
												<td><%=oi.getQuantity()%></td>
												<td><%=oi.getUnitPrice()%></td>
			...
			$("#idSearchBtn")
					.click(
							function() {
								...
								let url = "${pageContext.request.contextPath}/orderIdItems?orderId="
