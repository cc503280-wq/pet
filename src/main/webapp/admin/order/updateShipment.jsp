							...
							<div class="card">
								...
								<div class="card card-info">
									...
									<form class="form-horizontal"
										action="${pageContext.request.contextPath}/shipmentsOrderChangeResponse">
										<div class="card-body">
											<c:set var="s" value="${shipmentsList[0]}" />

											<div class="form-group row">
												<label class="col-sm-2 col-form-label">物流編號:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control"
														value="${s.shipmentId}" name="shipmentId" readonly>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control"
														value="${s.shippingMethod}" readonly>
												</div>
											</div>

											<div class="form-group row">
												<label class="col-sm-2 col-form-label">物流運費:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control"
														value="${s.shippingFee}" readonly>
												</div>
											</div>

											<div class="form-group row">
												<label class="col-sm-2 col-form-label">物流追蹤碼:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control"
														name="trackingNumber" value="${s.trackingNumber}"
														name="trackingNumber">
												</div>
											</div>

											<div class="form-group row">
												<label class="col-sm-2 col-form-label">寄送日期:</label>
												<div class="col-sm-10">
													<input type="date" class="form-control" name="shippedAt"
														value="${s.shippedAt}">
												</div>
											</div>

											<div class="form-group row">
												<label class="col-sm-2 col-form-label">到達日期:</label>
												<div class="col-sm-10">
													<input type="date" class="form-control" name="deliveredAt"
														value="${s.deliveredAt}">
												</div>
											</div>

											<div class="form-group row">
												<label class="col-sm-2 col-form-label">物流狀態:</label>
												<div class="col-sm-10">
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control"
														value="${s.recipientName}" readonly>
												</div>
											</div>

											<div class="form-group row">
												<label class="col-sm-2 col-form-label">收件人電話:</label>
												<div class="col-sm-10">
													<input type="text" class="form-control"
														value="${s.recipientPhone}" readonly>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control"
														value="${s.shippingAddress}" readonly>
												</div>
											</div>
